 ...
 *
 */
class UserContextFactory implements UserDataInterface {
  ...
  /**
   * @var  array*/
  public $cookiesUpdate = [];

  /**
   *
   */
  public function getUserContext(AccountProxyInterface $account, UserDataInterface $user_data) {
