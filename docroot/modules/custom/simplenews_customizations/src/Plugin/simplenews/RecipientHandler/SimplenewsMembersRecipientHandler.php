...
/**
 * @RecipientHandler(
 *  id = "simplenews_members",
 *  title = @Translation("Simplenews by members."),
 *  description = @Translation("Simplenews by members."),
 *  types = {
 *    "members"
 *  }
 * )
 */
class SimplenewsMembersRecipientHandler extends RecipientHandlerExtraBase implements RecipientHandlerInterface, ContainerFactoryPluginInterface {
